...
%, and that all primates would be intelligently superior to every other animal.

%When the intelligence of animals was started to be measured and compared in 1911

%Historically, two conceptions has dominated the view of animal intelligence:  1. humans have been assumed to be the only species with a soul (here interpreted as a mind) 2. all animals can be ordered after increasing intelligence \cite{mackintosh1988animals}.

%Assuming that humans have minds, we pose the question: what other entities have minds as well?
%Clearly, a necessary requirement for a mind is some kind of intelligent behaviour. The 
...
Slime mould are unicellular amoeba which, when food is in short supply, can form into networks that coordinate and display behaviours similar to animals with simple brains. This is extraordinary, since individual cells are not known to have the ability to think. Yet somehow a large collection of these individuals is able to display a degree of intelligence when put together, something which can be seen in the example with slime mould. An experiment showed that a mass of slime mould was able to generate a rail network over Tokyo that was strikingly similar to the network actually used \cite{tero2010rules}. \todo{7 may 13:13, Björn working here}
